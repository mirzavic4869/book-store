...
const EditBook = () => {
	...
	return (
		<div className="p-4">
			<BackButton />
			<h1 className="my-4 text-3xl font-bold">Edit Book</h1>
			{loading ? <Spinner /> : ""}
			<div className="flex flex-col p-4 mx-auto rounded-xl shadow-lg bg-white md:w-[600px]">
				<div className="p-4">
				...
				<button className="p-2 m-8 text-white bg-teal-600 rounded-md" onClick={handleEdit}>
					Submit
				</button>
			</div>
		</div>
